...
- **Phase 21 — Product trust and polish.** Copy and flow polish, project-aware recommendation applicability, score explanation, and targeted visual cleanup. ← _current_
- **Phase 22 — GitHub client efficiency and org support.** ETag conditional requests, request-budget indicator, optional GraphQL path, organization analysis, changed-repo-only refresh.
