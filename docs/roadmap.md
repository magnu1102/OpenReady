...
- **Phase 21 — GitHub client efficiency and org support.** ETag conditional requests, request-budget indicator, optional GraphQL path, organization analysis, changed-repo-only refresh. ← _current_
